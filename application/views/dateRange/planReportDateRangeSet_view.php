                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="input-prepend">
                                ...
                                <select id="end_time" name="end_time" class="input-small" style="background-color: cornsilk;">
                                    <option value="">--請選擇--</option>
                                    <?php
                                    foreach( $month as $k=>$v):
                                        ?>
                                        <option value="<?php echo $k;?>" <?php echo ($k==$option_02) ? 'selected': '' ;?>><?php echo $v; ?></option>
                                    <?php
                                    endforeach;
                                    ?>
                                </select>
